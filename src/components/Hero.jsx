      ...
      <div className="container mx-auto flex px-5 pt-20 items-center justify-center flex-col">
        <div className="text-center lg:w-2/3 w-full">
          ...
          <div className="flex justify-center">
            <Link href="mailto:info@virtualcrafterstek.com"><button className="ml-4 mb-4 inline-flex text-black bg-gray-300 border-0 py-3 px-12 focus:outline-none  rounded-3xl text-lg">
             Free Consultation
            </button></Link>
          </div>
        </div>
