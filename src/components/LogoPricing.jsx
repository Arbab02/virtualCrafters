    ...
    <div className={`h-full p-6 rounded-lg flex flex-col relative overflow-hidden ${badge ? "border-indigo-500" : "border-gray-700"}`}>
      {badge && (
        ...
        {features.length > 5 && (
         ...
         <Link href="mailto:irtualcrafterstek.com" ><button className={`flex items-center mt-auto ${buttonStyle} border-0 py-2 px-4 w-full focus:outline-none  rounded-full`}>
          {buttonText}
        </button></Link>
